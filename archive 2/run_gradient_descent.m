<<<<<<< Updated upstream:run_gradient_descent.m
...
=======
    ...
    % Unpack params
>>>>>>> Stashed changes:archive 2/run_gradient_descent.m
    beta = params.beta;
    gamma = params.gamma;
    max_iter = params.max_iter;
    min_gradient = params.min_gradient;
...
=======
    ...
    V_history = v;     % store initial guess
    ...
    while n < max_iter && norm(g) > min_gradient
        ...
        v = v - alpha * g; % update position
        V_history(:, end+1) = v; % store current v
